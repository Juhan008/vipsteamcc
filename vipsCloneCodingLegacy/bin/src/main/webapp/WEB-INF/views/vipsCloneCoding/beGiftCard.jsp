										...
										<li><a href="beGiftCard">
											...
											<div class="contents-box">
												...
												<dl class="giftcard img01">
													...
													<dt>
														<img
															src="/resources/images/benefit/beGiftCard/notice01.png">
													</dt>
													<dd class="notice01">
														<p>뚜레쥬르, 빕스, 더플레이스, 계절밥상, 제일제면소, CJ푸드월드에서 사용 가능합니다.
															(단, 일부 매장 제외)</p>
														<ul class="clfix">
															<li><img
													...
													<dt class="notice02_top">
														<img
															src="/resources/images/benefit/beGiftCard/notice02.png">
													</dt>
													<dd class="notice02">
														<ul class="contents-txt">
															<li>상품권은 액면가액이 1만원 초과 시 60%, 1만원 이하 시 80% 이상을 사용하시는
																경우 잔액을 현금으로 지급 받을 수 있으며,<br>상품권을 2매 이상 사용하시는 경우
																액면가액의 총합계 금액 기준으로 적용됩니다.
															</li>
															<li>잔액 지급 기준 미만으로 상품권 사용 시 잔액에 대해 현금 또는 상품권으로 지급하지
																않습니다.</li>
															<li>상품권은 현금으로 교환되지 않습니다.</li>
															<li>상품권이 심하게 훼손되어 상품권의 액면가액 및 발행 번호의 파악이 불가능 하거나,
																발행사 상품권임을 식별할 수 없는 경우는<br>사용할 수 없습니다.
															</li>
