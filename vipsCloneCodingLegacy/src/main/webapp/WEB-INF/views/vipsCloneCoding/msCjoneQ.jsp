					...
					<div id="container" class="clfix">
						...
						<div id="content-wrap" class="clfix">
							...
							<div class="visual-sub benefit-visual">
								...
								<p>
									<img
										src="/resources/images/membership/msCjoneQ/CJ_top_text.png">
								</p>
							</div>
							<div id="content">
								<h5>
								...
								<div class="cjone-benefit">
									<ul>
										...
										<li class="cj-bnf2">
											<div class="cont-wrap">
												<h6 class="tit">
													<img src="/resources/images/membership/msCjoneQ/txt_cjone_bnf02.png"
														alt="혜택02 포인트 적립">
												</h6>
												<p class="description">
										...
										<li class="cj-bnf3">
											<div class="cont-wrap">
												<h6 class="tit">
													<img src="/resources/images/membership/msCjoneQ/txt_cjone_bnf03.png"
														alt="혜택03 포인트 사용">
												</h6>
												<p class="description">
													1,000포인트 이상 보유 시,<br>10포인트 단위로 <strong>현금처럼
														사용</strong>
												</p>
											</div>
											<div class="bnf-btn">
										...
										<li class="cj-bnf4">
											<div class="cont-wrap">
												<h6 class="tit">
													<img src="/resources/images/membership/msCjoneQ/txt_cjone_bnf04.png"
										...
										<li class="cj-bnf5">
											<div class="cont-wrap">
												<h6 class="tit">
													<img src="/resources/images/membership/msCjoneQ/txt_cjone_bnf05.png"
														alt="혜택05 포인트 선물하기">
												</h6>
												<p class="description">
