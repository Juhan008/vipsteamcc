...
<link rel='stylesheet' href='/resources/styles/beverage03.css' />
</head>
<body>
	<div id="root">
				...
				<div class="mainContent02">
					...
					<div class="content02">
						<div class="content-top02">
							...
							<div class="sns-Link" onclick="snsLink_5()">								
						...
						<div class="content-bottom02">
							<ul class="content03-menus">
								...
								<li>
									<a href="/saladBeverage03">
										<img src="/resources/images/templet_beverage/Beers (1).gif">
									</a>
								</li>								
							</ul>
							<hr class="line">
							<div class="mainContent01">
								<div class="menu01">
									<img src="/resources/images/templet_beverage/생맥주.jpeg">
								</div>
