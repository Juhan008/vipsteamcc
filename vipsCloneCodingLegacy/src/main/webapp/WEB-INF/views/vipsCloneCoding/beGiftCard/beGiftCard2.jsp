					...
					<div id="content">
						<ul class="discount-tab clfix" style="height: 1000px">
							<li><a href="beGiftCard">
									<h5>
										<img
											src="/resources/images/benefit/beGiftCard/tab_CJ_family.gif"
											alt="CJ 패밀리 상품권">
									</h5>
							</a></li>
							<li><a href="beGiftCard2"><h5>
										<img
											src="/resources/images/benefit/beGiftCard/tab_beGiftCard2_on.gif"
											alt="매장별제휴할인">
									</h5></a>
								<div class="contents-box">
									<p class="dot">
										<strong>빕스</strong>에서 사용 가능한 상품권 입니다.
									</p>

									<ul class="giftCard-list first">
										<li><p>
												<img
													src="/resources/images/benefit/beGiftCard/img_giftcard04.png"
													alt="">
											</p> <strong>CJ 상품권</strong></li>
										<li><p>
												<img
													src="/resources/images/benefit/beGiftCard/img_giftcard04.png"
													alt="">
										...
										<dd>
											<ul class="contents-txt">
												<li>상품권은 액면가액이 1만원 초과 시 60%, 1만원 이하 시 80% 이상을 사용하시는 경우
													잔액을 현금으로 지급 받을 수 있으며,<br>상품권을 2매 이상 사용하시는 경우 액면가액의 총합계
													금액 기준으로 적용됩니다.
												</li>
												...
												<li>상품권의 유효기간은 발행일로부터 5년입니다.</li>
												<li>상품권은 지류 상품권으로만 사용 가능하며, 모바일 상품권은 사용 불가합니다.</li>
												<li>사용 시 불편한 사항은 고객센터로 연락 주시기 바랍니다. (고객센터: 1577-0700)</li>
												<li>배달 전용 매장에서는 사용이 불가합니다.</li>
											</ul>
										</dd>
									</dl>
								</div></li>
