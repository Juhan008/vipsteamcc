...
<link rel='stylesheet' href='/resources/styles/allergyDelivery02.css' />
</head>
<body>
	<div id="root">
		<div class="headerLocation"><jsp:include
				page="template/templateHeaderFirst.jsp"></jsp:include></div>
			...
			<div class="content02">
				<div class="content-top02">
					...
					<div class="contentText">
						<div class="text01">
							<img
								src="/resources/images/templet_allergyDelivery/알레르기 정보(딜리버리).png">
						</div>
						<div class="text02">
					...
					<div class="contentImage">
						<img
							src="/resources/images/templet_salad/templet_salad_bgmain.png">
					</div>
				</div>
				<!-- <div class="line">
				...
				<div class="content-bottom02">
					<ul class="rawMaterial">
						<li class="firstList"><a href="/allergyDelivery">
								<img src="/resources/images/templet_allergy/난류.gif">
							</a></li>
						<li class="otherList"><a href="/allergyDelivery02">
								<img
									src="/resources/images/templet_allergy/txt_material02_on.gif">
							</a></li>
						<!-- 
								<li class="otherList">
				...
				<div class="caution">
					...
					<div class="cautionList">
						...
						<div class="listText">주요 메뉴 중 식품위생법 상 표기 대상 원료에 대한 안내사항입니다.
						</div>
						<div class="listImage">
							<img src="/resources/images/templet_saladMain/bul_4dot.png">
						</div>
						<div class="listText">알레르기는 개인 체질 등에 따라 발생하는 식품이 다를 수 있으니,
							해당 여부를 꼭 확인하여 주시기 바랍니다.</div>
						<div class="listImage">
							<img src="/resources/images/templet_saladMain/bul_4dot.png">
						</div>
						<div class="listText">상기 메뉴는 매장별로 상이할 수 있습니다.</div>
						<div class="listImage">
							<img src="/resources/images/templet_saladMain/bul_4dot.png">
						</div>
						<div class="listText">전체보기로 보시면 가나다순으로 표기됩니다.</div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="footerLocation"><jsp:include
				page="template/templateFooterFirst.jsp"></jsp:include></div>
	</div>
</body>
</html>