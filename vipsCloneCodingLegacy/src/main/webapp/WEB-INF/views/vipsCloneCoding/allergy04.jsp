...
<link rel='stylesheet' href='/resources/styles/allergy04.css' />
</head>
<body>	
	<div id="root">
					...
					<div class="content02">
						...
						<div class="content-bottom02">
							<ul class="rawMaterial">
								...
								<li class="otherList">
									<a href="/allergy04">
										<img src="/resources/images/templet_allergy/txt_material04_on.gif">
									</a>
								</li>
								<li class="otherList">
									<a href="/allergy05">
						...
						<div class="material-infoBox">
							<div class="infoBox-01">
								<div class="division-01">${allergyService.getDivision02()}</div>
							</div>
							...
							<div class="infoBox-01">
								<div class="division-02">${allergyService.getDivision08()}</div>
							</div>
							<div class="infoBox-02">
