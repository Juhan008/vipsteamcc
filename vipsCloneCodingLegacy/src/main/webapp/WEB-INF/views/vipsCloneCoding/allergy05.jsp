...
<link rel='stylesheet' href='/resources/styles/allergy05.css' />
</head>
<body>	
	<div id="root">
					...
					<div class="content02">
						...
						<div class="content-bottom02">
							<ul class="rawMaterial">
								...
								<li class="otherList">
									<a href="/allergy05">
										<img src="/resources/images/templet_allergy/txt_material05_on.gif">
									</a>
								</li>
								<li class="otherList">
									<a href="/allergy">
						...
						<div class="material-infoBox">
							...
							<div class="infoBox-01">
								<div class="division-05">${allergyService.getDivision04()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-06">${allergyService.getDivision05()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-07">${allergyService.getDivision06()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-08">${allergyService.getDivision07()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-09">${allergyService.getDivision08()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-10">${allergyService.getDivision09()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-11">${allergyService.getDivision10()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-12">${allergyService.getDivision11()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-13">${allergyService.getDivision12()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-14">${allergyService.getDivision17()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-15">${allergyService.getDivision13()}</div>
							</div>
							<div class="infoBox-02">
							...
							<div class="infoBox-01">
								<div class="division-16">${allergyService.getDivision14()}</div>
							</div>
							<div class="infoBox-02">
								<c:forEach var="item" items="${division16}">
									<div class="menu-01">${item.getMenu()}</div>
								</c:forEach>
							</div>
							<div class="infoBox-03">
							...
							<div class="infoBox-01">
								<div class="division-17">${allergyService.getDivision15()}</div>
							</div>
							<div class="infoBox-02">
								<c:forEach var="item" items="${division17}">
									<div class="menu-01">${item.getMenu()}</div>
								</c:forEach>
							</div>
							<div class="infoBox-03">
