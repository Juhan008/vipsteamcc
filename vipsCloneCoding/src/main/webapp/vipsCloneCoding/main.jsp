		...
		<div class="padding-box">
			<div class="background-area">
				<div class="background-inner-area">
					...
					<div class="relevant-box-containing-content">
					...
					<div class="foot">
						<div class="foot-site">
							<div class="foot-site-icon-area">
								...
								<img src="../images/main/foot-touslesjours-icon.gif" alt="뚜레주르"
									class="foot-site-icon" />
								...
								<img src="../images/main/foot-ngrill-icon.gif" alt="엔그릴"
									class="foot-site-icon" />
								<img src="../images/main/foot-nseoul-tower-icon.gif" alt="엔서울타워"
									class="foot-site-icon" />
							</div>
						</div>
						<div class="foot-menu">
